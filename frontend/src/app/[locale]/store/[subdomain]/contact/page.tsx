...
import { Mail, Phone, MessageSquare, Instagram, MapPin, Send, Loader2, Clock } from "lucide-react";
                ...
                <div className="space-y-8">
                        ...
                        {contact.email && (
                            <Card className="rounded-[32px] border-2 border-transparent bg-gray-50 hover:bg-white hover:border-blue-50 transition-all duration-300 shadow-sm hover:shadow-xl group">
                                <CardContent className="p-8 space-y-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">{t('emailUs')}</p>
                        ...
                        {contact.phone && (
                            <Card className="rounded-[32px] border-2 border-transparent bg-gray-50 hover:bg-white hover:border-blue-50 transition-all duration-300 shadow-sm hover:shadow-xl group">
                                <CardContent className="p-8 space-y-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">{t('callUs')}</p>
                        ...
                        {contact.whatsapp && (
                            <Card className="rounded-[32px] border-2 border-transparent bg-gray-50 hover:bg-white hover:border-green-50 transition-all duration-300 shadow-sm hover:shadow-xl group">
                                <CardContent className="p-8 space-y-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">{t('whatsapp')}</p>
                        ...
                        {contact.instagram && (
                            <Card className="rounded-[32px] border-2 border-transparent bg-gray-50 hover:bg-white hover:border-pink-50 transition-all duration-300 shadow-sm hover:shadow-xl group">
                                <CardContent className="p-8 space-y-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">{t('instagram')}</p>
                    ...
                    <div className="p-12 bg-black rounded-[40px] text-white space-y-6 relative overflow-hidden">
                        <div className="flex items-center gap-4">
                            ...
                            <h3 className="text-xl font-bold">{t('businessHours')}</h3>
                        </div>
                ...
                <Card className="rounded-[40px] border-2 shadow-2xl overflow-hidden animate-in fade-in slide-in-from-right-10 duration-700">
                    <CardContent className="p-8 md:p-12 space-y-8">
                        <div className="space-y-1">
                            ...
                            <p className="text-gray-400 font-medium">{t('formSubtitle')}</p>
                        </div>

                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest ml-1">{t('labels.name')}</label>
                                    <Input required placeholder={t('placeholders.name')} className="h-14 rounded-2xl border-2 focus-visible:ring-offset-0 focus-visible:ring-2" style={{ borderColor: primaryColor + '20' }} />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest ml-1">{t('labels.email')}</label>
                                    <Input required type="email" placeholder={t('placeholders.email')} className="h-14 rounded-2xl border-2 focus-visible:ring-offset-0 focus-visible:ring-2" style={{ borderColor: primaryColor + '20' }} />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest ml-1">{t('labels.subject')}</label>
                                <Input required placeholder={t('placeholders.subject')} className="h-14 rounded-2xl border-2 focus-visible:ring-offset-0 focus-visible:ring-2" style={{ borderColor: primaryColor + '20' }} />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest ml-1">{t('labels.message')}</label>
                                <Textarea required rows={5} placeholder={t('placeholders.message')} className="rounded-2xl border-2 focus-visible:ring-offset-0 focus-visible:ring-2 resize-none" style={{ borderColor: primaryColor + '20' }} />
                            </div>
