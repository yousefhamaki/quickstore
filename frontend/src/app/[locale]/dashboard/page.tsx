                ...
                <div className="max-w-7xl mx-auto space-y-4">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="space-y-1">
                            ...
                            <p className="text-muted-foreground">Manage your e-commerce empire from a single dashboard.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                        <div className="bg-muted/50 p-4 rounded-2xl border flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Active Stores</p>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 mt-10 space-y-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-2xl font-bold">My Online Stores</h2>
                    </div>
