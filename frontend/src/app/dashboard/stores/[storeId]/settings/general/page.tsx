            ...
            <form onSubmit={onSubmit} className="space-y-8">
                ...
                <Card className="border-2 shadow-sm rounded-2xl overflow-hidden bg-muted/5 border-dashed">
                    ...
                    <CardContent className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="space-y-1">
                            <p className="text-sm font-bold text-primary font-mono">{store.domain.subdomain}.quickstore.com</p>
                        ...
                        <Button variant="secondary" size="sm" asChild className="rounded-full">
                            <a href={`https://${store.domain.subdomain}.quickstore.com`} target="_blank" rel="noopener noreferrer">
                                Visit Store
                            </a>
                        </Button>
                    </CardContent>
