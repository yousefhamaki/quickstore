...
//
// Mirrored at backend/src/constants/egyptianGovernorates.ts — keep both
// copies in sync by hand (backend/ and frontend/ are separate Node projects
// with no shared module boundary). Both the merchant Shipping Settings
// governorate picker and the storefront checkout governorate selector
// import from this single shared list.
