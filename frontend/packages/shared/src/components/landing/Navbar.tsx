...
export function Navbar() {
    ...
    return (
        <div className="fixed top-0 w-full z-50 flex flex-col">
            {/* Campaign Banner */}
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white text-center py-2.5 px-4 text-[10px] sm:text-xs md:text-sm font-bold flex items-center justify-center gap-1.5 relative border-b border-white/10 shadow-md">
                <Gift className="w-4 h-4 animate-pulse flex-shrink-0 text-yellow-300" />
                <span>
                    {isAr
                        ? "حملة الإطلاق: سجل الآن واحصل على 500 ج.م رصيد ترحيبي لتشغيل متجرك مجاناً لمدة تصل إلى شهرين!"
                        : "Launch Campaign: Sign up today and get 500 EGP welcome credit to run your store free for up to 2 months!"}
                </span>
                <NavLink
                    href="/auth/register"
                    className="underline hover:text-white/80 ml-1 font-black transition-colors"
                >
