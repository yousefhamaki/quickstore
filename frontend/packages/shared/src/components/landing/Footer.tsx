        ...
        <footer className="bg-gray-900 text-white py-20 mt-auto">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-gray-800 pb-20 mb-10">
                ...
                <div className="space-y-4">
                    <h3 className="font-black uppercase text-xs tracking-widest text-blue-500">{t('footer.product')}</h3>
                ...
                <div className="space-y-4">
                    <h3 className="font-black uppercase text-xs tracking-widest text-blue-500">{t('footer.company')}</h3>
