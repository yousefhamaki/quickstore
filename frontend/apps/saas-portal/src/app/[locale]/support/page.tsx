...
import { Mail, MessageCircle, Phone, HelpCircle, ArrowRight, ExternalLink, X, Send, User, ChevronRight } from 'lucide-react';
            ...
            <section className="py-20 bg-gray-50/50 border-y border-gray-100">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="space-y-6">
                        {loading ? (
                            <div className="text-center text-gray-500 py-10 font-medium">Loading Knowledge Base Articles...</div>
                        ) : focusedArticle ? (
