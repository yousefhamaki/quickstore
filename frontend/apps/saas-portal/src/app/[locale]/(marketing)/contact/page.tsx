                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="bg-white p-8 md:p-10 rounded-3xl border-2 border-gray-100 shadow-xl shadow-blue-50">
                            ...
                            <form className="space-y-6 text-left rtl:text-right">
                                ...
                                <Button className="w-full h-14 text-lg font-bold rounded-xl bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200 transition hover:scale-[1.02]">
                                    {t('form.submit')}
...
function InfoCard({ icon, label, value, color }: { icon: React.ReactNode, label: string, value: string, color: 'blue' | 'green' | 'purple' | 'pink' }) {
    ...
    return (
        <div className="flex items-center gap-6 p-6 rounded-2xl bg-white border border-gray-100 hover:shadow-lg transition text-left rtl:flex-row-reverse rtl:text-right">
...
function FAQCard({ question, answer }: { question: string, answer: string }) {
    return (
        <div className="p-8 rounded-3xl bg-white border border-gray-100 hover:shadow-xl transition text-left rtl:text-right">
