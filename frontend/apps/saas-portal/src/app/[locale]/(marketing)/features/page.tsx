...
function FeatureCard({
    ...
    return (
        <div className={`group p-8 rounded-3xl bg-white border-2 border-gray-100 ${colors.border} hover:shadow-2xl transition duration-300 hover:-translate-y-2`}>
...
function PaymentCard({
    ...
    return (
        <div className="group p-8 rounded-3xl bg-white border-2 border-gray-100 hover:border-blue-500 hover:shadow-2xl transition duration-300">
...
function ManagementCard({
    ...
    return (
        <div className={`group p-10 rounded-3xl bg-white border-2 border-gray-100 ${colors.border} hover:shadow-2xl transition duration-300 hover:-translate-y-2`}>
