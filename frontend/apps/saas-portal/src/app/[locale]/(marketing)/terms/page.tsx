        ...
        <div className="flex flex-col min-h-screen bg-white selection:bg-purple-100 selection:text-purple-900">
            <main className="flex-grow">
                ...
                <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
                    ...
                    >
                        <Badge className="mb-6 bg-purple-600 hover:bg-purple-700 text-white border-0 px-6 py-2 rounded-full text-xs font-bold shadow-lg shadow-purple-200 transition uppercase tracking-widest">
                            {t('hero.badge')}
                        </Badge>
                        ...
                        >
                            ...
                            {(t.raw('sections') as any[]).map((section: any) => (
                                <motion.div
                                    ...
                                    className="group relative p-8 md:p-10 rounded-[2.5rem] border border-gray-100 bg-white hover:border-purple-200 hover:shadow-2xl hover:shadow-purple-50 transition duration-500 overflow-hidden"
                                >
                                    ...
                                    <div className="flex flex-col md:flex-row items-start gap-8 rtl:md:flex-row-reverse relative z-10">
                                        <div className="flex-shrink-0 w-16 h-16 rounded-[1.25rem] bg-purple-50 text-purple-600 flex items-center justify-center group-hover:bg-purple-600 group-hover:text-white group-hover:rotate-6 group-hover:scale-110 transition duration-500 shadow-sm">
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div>
                                    <a
                                        ...
                                        className="inline-flex items-center gap-3 text-xl font-bold bg-white text-gray-900 px-10 py-5 rounded-2xl hover:bg-purple-50 hover:scale-105 active:scale-95 transition shadow-xl shadow-black/20"
                                    >
