        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-16">
            <NavLink href="/auth/register">
              <Button
                size="lg"
                className="h-14 md:h-16 px-8 md:px-12 text-lg md:text-xl rounded-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-2xl shadow-blue-300 hover:shadow-blue-400 font-bold transition duration-300 hover:scale-105"
              >
            ...
            <Button
              variant="outline"
              size="lg"
              className="h-14 md:h-16 px-8 md:px-12 text-lg md:text-xl rounded-full font-bold border-2 border-gray-300 hover:border-blue-600 hover:bg-blue-50 transition duration-300"
            >
              {t('hero.ctaSecondary')}
            </Button>
          </div>
          ...
          <div className="text-center">
            <NavLink href="/features">
              <Button
                variant="outline"
                size="lg"
                className="rounded-full px-8 md:px-10 font-bold border-2 border-gray-300 hover:border-purple-600 hover:bg-purple-50 hover:text-purple-700 transition duration-300"
              >
      ...
      <section className="py-20 md:py-32 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <NavLink href="/auth/register">
            <Button
              size="lg"
              className="h-16 px-12 text-xl rounded-full bg-white text-blue-600 hover:bg-gray-100 shadow-2xl font-bold transition duration-300 hover:scale-105"
            >
...
function FeatureCard({
  ...
  return (
    <div className={`group p-8 md:p-10 rounded-3xl bg-white border-2 border-gray-100 ${colors.border} hover:shadow-2xl ${colors.shadow} transition duration-300 hover:-translate-y-2`}>
