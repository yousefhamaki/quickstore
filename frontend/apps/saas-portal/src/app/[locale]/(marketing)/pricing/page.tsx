...
export default function PricingPage() {
 ...
 function PricingCard({
     ...
     return (
         <div className={`relative p-8 md:p-10 rounded-3xl bg-white border-2 transition duration-300 hover:-translate-y-2 ${isPopular ? 'border-blue-600 shadow-xl shadow-blue-100 md:scale-105 z-10' : 'border-gray-100 hover:border-blue-200 hover:shadow-xl'}`}>
             {isPopular && (
             ...
             <div className="block mb-10">
                 <Button
                     onClick={onSelect}
                     className={`w-full h-14 text-lg font-bold rounded-xl transition ${isPopular ? 'bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200' : 'bg-gray-900 hover:bg-gray-800'}`}
                 >
                     {buttonText}
                 </Button>
             </div>
...
function FAQItem({ question, answer }: { question: string, answer: string }) {
    return (
        <div className="p-8 rounded-2xl bg-white border border-gray-100 hover:shadow-lg transition">
