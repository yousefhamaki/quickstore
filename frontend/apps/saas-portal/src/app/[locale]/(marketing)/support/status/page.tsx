...
import { getSupportTicketStatus } from '@shared/lib/api/support';
                ...
                <form onSubmit={handleSearch} className="relative mb-12">
                    <div className="relative group">
                        ...
                        <Input
                            ...
                            className="h-20 pl-16 pr-40 rounded-3xl border-2 border-gray-100 bg-gray-50 text-xl font-bold focus:bg-white transition shadow-sm focus:shadow-xl focus:border-blue-500"
                            value={ticketId}
