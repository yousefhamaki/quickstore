            ...
            <section className="py-20 md:py-32 bg-gray-900 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <NavLink href="/auth/register">
                        <Button
                            size="lg"
                            className="h-16 px-12 text-xl rounded-full bg-blue-600 hover:bg-blue-700 text-white font-bold transition hover:scale-105"
                        >
...
function ValueCard({ title, description, icon }: { title: string, description: string, icon: React.ReactNode }) {
    return (
        <div className="p-10 rounded-3xl bg-white border-2 border-gray-50 hover:border-blue-500 hover:shadow-2xl transition duration-300 text-left rtl:text-right">
