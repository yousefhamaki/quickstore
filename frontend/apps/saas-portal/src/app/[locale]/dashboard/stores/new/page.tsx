...
import { createStoreSchema } from "@shared/lib/schemas/store";
import { useCreateStore } from "@shared/lib/hooks/useStores";
import { checkSubdomainAvailability } from "@shared/lib/api/stores";
                            ...
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        id="category"
                                        {...register("category")}
                                        className="w-full h-10 px-3 rounded-md border border-input bg-background focus:ring-2 focus:ring-primary/20 outline-none transition"
                                    >
