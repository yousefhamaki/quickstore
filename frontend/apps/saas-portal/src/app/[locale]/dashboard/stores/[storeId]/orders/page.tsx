...
import { BillingGuardModal } from "@shared/components/merchant/BillingGuardModal";
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <form onSubmit={handleSearch} className="relative flex-1">
                            ...
                            <input
                                ...
                                className={`w-full ${localeString === 'ar' ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-2 rounded-xl border-border bg-background focus:ring-2 focus:ring-primary/20 border transition text-sm outline-none`}
                            />
                        </form>
                        <div className="flex items-center gap-2">
                            <select
                        ...
                        <div className="overflow-x-auto">
                            <table className={`w-full text-sm ${localeString === 'ar' ? 'text-right' : 'text-left'}`}>
                                ...
                                <tbody className="divide-y">
                                    {[1, 2, 3, 4, 5].map((i) => (
                                        <tr key={i}>
                                            <td className="px-6 py-4"><div className="h-3 w-16 rounded bg-muted animate-pulse" /></td>
