...
import { getCustomers } from "@shared/services/customerService";
        ...
        <div className="p-4 md:p-8 space-y-8 animate-in fade-in duration-500">
            ...
            <Card className="border-2 shadow-sm rounded-[32px] overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className={`w-full ${localeString === 'ar' ? 'pr-12 pl-4 text-right' : 'pl-12 pr-4 text-left'} h-12 rounded-2xl border-border bg-background focus:ring-4 focus:ring-primary/10 border-2 transition text-sm font-bold outline-none`}
                            />
                        </div>
                ...
                <CardContent className="p-0">
                    {loading ? (
                        // Shaped like the real table below, not a spinner —
                        // see products/page.tsx for the same pattern.
                                ...
                                <tbody className="divide-y divide-border">
                                    {[1, 2, 3, 4, 5].map((i) => (
                                        <tr key={i}>
                                            ...
                                            <td className="px-6 py-5"><div className="h-5 w-16 rounded-full bg-muted animate-pulse" /></td>
                                            <td className="px-6 py-5"><div className="h-3 w-24 rounded bg-muted animate-pulse" /></td>
                                            <td className={`px-6 py-5 ${localeString === 'ar' ? 'text-left' : 'text-right'}`}>
                                                <div className={`flex ${localeString === 'ar' ? 'justify-start' : 'justify-end'}`}>
