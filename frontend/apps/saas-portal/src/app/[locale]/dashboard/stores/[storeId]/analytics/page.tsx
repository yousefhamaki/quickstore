                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {store?.settings?.marketing?.facebookPixelId && (
                                <a
                                    ...
                                    className="p-4 rounded-2xl border-2 hover:border-blue-500 transition flex items-center justify-between group"
                                >
                            ...
                            {store?.settings?.marketing?.googleAnalyticsId && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="p-4 rounded-2xl border-2 hover:border-orange-500 transition flex items-center justify-between group"
                                >
                                    <div className="flex items-center gap-3">
                            ...
                            {store?.settings?.marketing?.tiktokPixelId && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="p-4 rounded-2xl border-2 hover:border-black transition flex items-center justify-between group"
                                >
                                    <div className="flex items-center gap-3">
                            ...
                            {store?.settings?.marketing?.snapchatPixelId && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="p-4 rounded-2xl border-2 hover:border-yellow-400 transition flex items-center justify-between group"
                                >
                                    <div className="flex items-center gap-3">
