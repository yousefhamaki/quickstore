...
import { useStore, usePublishStore } from "@shared/lib/hooks/useStore";
...
const OnboardingChecklist = dynamic(() => import("@shared/components/dashboard/OnboardingChecklist").then(m => m.OnboardingChecklist), { ssr: false });
const PublishModal = dynamic(() => import("@shared/components/dashboard/PublishModal").then(m => m.PublishModal), { ssr: false });
