...
export type LedgerEntryType = 'monthly_grant' | 'purchase' | 'campaign_debit' | 'transactional_debit' | 'bounce_refund' | 'correction' | 'transfer_out' | 'transfer_in' | 'expired';
...
const EmailLedgerEntrySchema: Schema = new Schema(
    {
        ...
        type: { 
            type: String, 
            enum: ['monthly_grant', 'purchase', 'campaign_debit', 'transactional_debit', 'bounce_refund', 'correction', 'transfer_out', 'transfer_in', 'expired'],
            required: true 
        },
